...
require (
	cloud.google.com/go v0.26.1-0.20180817232204-b2d9c45edf0f // indirect
	...
	github.com/pkg/errors v0.8.1-0.20181008045315-2233dee583dc
	...
	k8s.io/apiextensions-apiserver v0.0.0-20180818025419-bdf885c46cff // indirect
	k8s.io/apimachinery v0.0.0-20171207040834-180eddb345a5
	k8s.io/apiserver v0.0.0-20180113034552-2a1092aaa720 // indirect
	k8s.io/client-go v6.0.0+incompatible
	k8s.io/helm v2.8.2+incompatible
	k8s.io/kube-openapi v0.0.0-20171101183504-39a7bf85c140 // indirect
	k8s.io/kubernetes v1.9.2
