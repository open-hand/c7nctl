...
const (
	...
	HzeroPlatform        = "hzero-platform"
	HzeroAdmin           = "hzero-admin"
	HzeroIam             = "hzero-iam"
	HzeroOauth           = "hzero-Oauth"
	HzeroGateWay         = "hzero-gateway"
	HzeroAsgard          = "hzero-asgard"
	HzeroSwagger         = "hzero-swagger"
	HzeroMessage         = "hzero-message"
	HzeroMonitor         = "hzero-monitor"
	HzeroFile            = "hzero-file"
